...
if torch.cuda.is_available() == True:
    os.environ["CUDA_VISIBLE_DEVICES"] ="1" # 这句用来设置pytorch在哪块GPU上运行，pytorch-cpu版本不需要运行这句
...
train_dataset = torchvision.datasets.CIFAR10(
    #如果数据集下载好了，就直接让download=DOWNLOAD
    root=cifar10Path, train=True, transform=transform, download=True
